...
const sections = [
  {
    ...
    color: 'from-purple-800/40 to-purple-900/20',
  ...
  },
  {
    ...
    color: 'from-violet-800/40 to-violet-900/20',
  ...
  },
  {
    ...
    color: 'from-fuchsia-800/40 to-fuchsia-900/20',
  ...
  },
  {
    ...
    color: 'from-indigo-800/40 to-indigo-900/20',
  ...
  },
  {
    ...
    color: 'from-pink-800/40 to-pink-900/20',
    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      <div className="mb-10">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">{meta.name}</h1>
            <p className="text-purple-400 text-sm mt-1 italic">{meta.tagline}</p>
          </div>
        </div>

        <p className="text-purple-200/80 text-sm leading-relaxed max-w-3xl">
          {meta.overview}
        </p>
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          {[
            ...
            <div
              key={label}
              className="bg-purple-900/30 border border-purple-800/50 rounded-xl px-4 py-2 text-center"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {sections.map(({ label, to, icon, description, color, border, accent }) => (
          <Link
            key={to}
            to={to}
            className={`group relative bg-gradient-to-br ${color} border ${border} rounded-2xl p-5 hover:scale-[1.02] transition-all duration-200 hover:shadow-lg hover:shadow-purple-900/30`}
          >
            <div className={`text-2xl mb-3 ${accent}`}>{icon}</div>
            <h3 className="text-white font-semibold text-sm mb-1">{label}</h3>
            <p className="text-purple-300/70 text-xs leading-relaxed">{description}</p>
      ...
      <div className="mt-10 p-4 bg-purple-950/40 border border-purple-900/50 rounded-xl text-center">
        <p className="text-purple-400 text-xs">
          Data last updated: June 2025 · All information is hardcoded for research purposes ·{' '}
          <Link to="/country/india/suggest" className="text-purple-300 hover:text-white underline">
